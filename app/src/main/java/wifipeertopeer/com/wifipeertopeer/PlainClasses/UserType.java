...
import wifipeertopeer.com.wifipeertopeer.Services.DetectedActivitiesIntentService;
...
public class UserType implements
    ...
    protected static final String TAG = "UserType";
    ...
    public UserType(Context context,ActivityDetectionBroadcastReceiver mBroadcastReceiver) {
        this.context = context;
        this.mBroadcastReceiver = mBroadcastReceiver;
    }

    public void setUserTypeListener(UserTypeListener listener) {
        mBroadcastReceiver.setUserTypeListener(listener);
